...
extension CategoryContentDataPatterns on CategoryContentData {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(CategoryInfo? category, List<GalleryItem>? content,
            ContentPagination? pagination)?
        $default, {
    required TResult orElse(),
  }) {
...
class _CategoryContentData implements CategoryContentData {
  const _CategoryContentData(
      {this.category, final List<GalleryItem>? content, this.pagination})
      : _content = content;
  ...
  final List<GalleryItem>? _content;
  @override
  List<GalleryItem>? get content {
